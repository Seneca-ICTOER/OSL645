...
Use the following [link](https://classroom.github.com/a/t59UX9BD) to set up your lab 4 repository. You will be using this for the Bash scripting in lab 4.
